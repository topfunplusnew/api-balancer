...
const SIGNATURE_CONFIG = {
    ...
    secret: process.env.API_N8N_SIGNATURE_SECRET || "",
};
/**
...
const handler = async (context) => {
    ...
    const signature = headers[SIGNATURE_CONFIG.headerName] || headers[SIGNATURE_CONFIG.headerName.toLowerCase()];
